...
; 
   CREATE TABLE imgs (
    ...
    , relative_path  varchar (100) NOT NULL DEFAULT 'src/perl/issue_tracker/public/dat/img/qto/...'
    , http_path      varchar (100) NOT NULL DEFAULT 'https://raw.githubusercontent.com/YordanGeorgiev/issue-tracker/dev/doc/img/..'
