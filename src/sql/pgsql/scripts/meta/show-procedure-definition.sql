-- call by: psql -d dev_qto -v PROCEDURE_NAME=func_fnc_get_all_app_user_roles < src/sql/pgsql/scripts/meta/show-procedure-definition.sql
...
WHERE       proname = 'func_fnc_get_all_app_user_roles' --ok
;
