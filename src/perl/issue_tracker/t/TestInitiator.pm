...
ok ( $ProductInstanceDir 	eq '/opt/csitea/issue-tracker/issue-tracker.0.0.4.dev.ysg' ); 
ok ( $ProductVersion 		eq '0.0.4' ); 
ok ( $EnvironmentName 		eq 'issue-tracker.0.0.4.dev.ysg' ); 
...
ok ( $ConfFile					eq 
'/opt/csitea/issue-tracker/issue-tracker.0.0.4.dev.ysg/cnf/issue-tracker.' . $cmd_out . '.cnf' ) ; 
