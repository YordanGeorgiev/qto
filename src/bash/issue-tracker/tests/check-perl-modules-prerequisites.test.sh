# src/bash/issue-tracker/funcs/check-perl-modules-prerequisites.test.sh
...
doTestCheckPerlModulesPrerequisites(){
	...
	cat doc/txt/issue-tracker/tests/check-perl-modules-prerequisites.test.txt
...
# eof file: src/bash/issue-tracker/funcs/check-perl-modules-prerequisites.test.sh
