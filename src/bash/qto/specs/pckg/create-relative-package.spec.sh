# src/bash/qto/funcs/create-relative-package.spec.sh
...
doSpecCreateRelativePackage(){
	...
	cat doc/txt/qto/specs/pckg/create-relative-package.spec.txt
...
# eof file: src/bash/qto/funcs/create-relative-package.spec.sh
