# src/bash/qto/funcs/restore-tmux-session.help.sh
...
doHelpRestoreTmuxSession(){
	...
	cat doc/txt/qto/helps/restore-tmux-session.help.txt
...
# eof file: src/bash/qto/funcs/restore-tmux-session.help.sh
