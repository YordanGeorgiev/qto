...
do_start(){
   ...
   echo -e "\n\n"
   echo ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
   echo "bootstrapping qto ... "
   echo "usually if this script fails a simple re-run would do it "
   echo ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
   sleep 2
}
...
do_finilize(){
   ...
   echo ":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
   echo "DONE"
   echo "NEXT you MUST reload your bash by: "
   echo "bash "
   echo "and than go to the PRODUCT_INSTANCE_DIR by: "
