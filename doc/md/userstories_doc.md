...
* [1. TEAM LEADER BIZ PERSPECTIVE](#1-team-leader-biz-perspective)
  ...
  * [1.2. TIME MANAGEMENT](#12-time-management)
    ...
    * [1.2.5. tracking of issues per target product version](#125-tracking-of-issues-per-target-product-version)
...
* [6. DEVOPS PERSPECTIVE](#6-devops-perspective)
  ...
  * [6.3. APPLICATION'S SOURCE CODE AND DOCUMENTATION INTEGRITY](#63-application's-source-code-and-documentation-integrity)
    ...
    * [6.3.2. UUID trackability for test files and userstories_doc](#632-uuid-trackability-for-test-files-and-userstories_doc)
...
* [7. COMMON UI PERSPECTIVE](#7-common-ui-perspective)
  ...
  * [7.2. SEARCH](#72-search)
    * [7.2.1. global search modal dialog ui](#721-global-search-modal-dialog-ui)
    * [7.2.2. SearchBox autocomplete for changing the project ( databases ) ](#722-searchbox-autocomplete-for-changing-the-project-(-databases-)-)
    * [7.2.3. SearchBox autocomplete for item-name](#723-searchbox-autocomplete-for-item-name)
    * [7.2.4. search-autocomplete on modal search dialog](#724-search-autocomplete-on-modal-search-dialog)
    * [7.2.5. SearchBox autocomplete for with &lt;&lt;attribute&gt;&gt; name &lt;&lt;operator&gt;&gt; &lt;&lt;attribute-value&gt;&gt;](#725-searchbox-autocomplete-for-with-attribute-name-operator-attribute-value)
  * [7.3. LIST](#73-list)
  ...
  * [7.9. HIERARCHICAL ITEMS MANAGEMENT](#79-hierarchical-items-management)
  * [7.10. ITEMS MOVE](#710-items-move)
  * [7.11. MOBILE UI](#711-mobile-ui)
  * [7.12. UI FOR ACCESSING DIFFERENT PROJECTS](#712-ui-for-accessing-different-projects)
  * [7.13. UI FOR TIME MANAGEMENT IN GOOGLE CALENDAR](#713-ui-for-time-management-in-google-calendar)
  * [7.14. ITEMS DATA TRANSFER BETWEEN DIFFERENT PROJECTS](#714-items-data-transfer-between-different-projects)
    * [7.14.1. Copy an qto instance issue to  a google calendar event](#7141-copy-an-qto-instance-issue-to-a-google-calendar-event)
  * [7.15. ISSUES IMPORT FROM GOOGLE CALENDAR](#715-issues-import-from-google-calendar)
  * [7.16. ACCESS ISSUES TXT FORMAT FROM EMAIL](#716-access-issues-txt-format-from-email)
  * [7.17. ACCESS ISSUES DATA FROM GOOGLE SHEET](#717-access-issues-data-from-google-sheet)
    * [7.17.1. Apply publish filter while posting to Google Sheet](#7171-apply-publish-filter-while-posting-to-google-sheet)
...
#### 1.2.5. tracking of issues per target product version
As Biz Manager 
...
In order to trace the issues relations to userstories_doc, features and tests or any other objects
...
#### 6.3.2. UUID trackability for test files and userstories_doc
As a Developer 
...
#### 7.2.1. global search modal dialog ui
As an UI user 
...
#### 7.2.2. SearchBox autocomplete for changing the project ( databases ) 
As an qto ui user 
...
#### 7.2.3. SearchBox autocomplete for item-name
As an qto ui user 
...
#### 7.2.4. search-autocomplete on modal search dialog
As an UI user 
...
#### 7.2.5. SearchBox autocomplete for with &lt;&lt;attribute&gt;&gt; name &lt;&lt;operator&gt;&gt; &lt;&lt;attribute-value&gt;&gt;
As an qto ui user 
...
### 7.9. hierarchical items management
As an the ui user
...
### 7.12. UI for accessing different projects
As an qto ui user 
In order to be able to quickly switch between projects of the qto application instance I have access to
...
### 7.13. UI for Time management in Google Calendar
As an qto ui user 
...
### 7.14. items data transfer between different projects
As the UI user of an qto instance 
...
#### 7.14.1. Copy an qto instance issue to  a google calendar event
As an qto ui user 
...
### 7.15. Issues import from Google calendar
As the UI user of an qto instance 
In order to be able to visualize and manage my  start- and stop_time having issues better 
...
### 7.16. Access issues txt format from email
...
### 7.17. Access issues data from Google sheet
...
#### 7.17.1. Apply publish filter while posting to Google Sheet
As the biz user  of the issue tracker tool 
