...
### 7.3. global search modal dialog ui
As an UI user 
...
#### 7.3.1. SearchBox autocomplete for changing the project ( databases ) 
As an issue-tracker ui user 
...
#### 7.3.2. SearchBox autocomplete for item-name
As an issue-tracker ui user 
...
### 7.4. search-autocomplete on modal search dialog
As an UI user 
...
#### 7.4.1. SearchBox autocomplete for with &lt;&lt;attribute&gt;&gt; name &lt;&lt;operator&gt;&gt; &lt;&lt;attribute-value&gt;&gt;
As an issue-tracker ui user 
...
#### 7.5.1. items listing in table format
As an UI user of the issue-tracker application 
...
##### 7.5.1.1. Automatic issue items sequencing
As an UI user of the issue-tracker application 
...
##### 7.5.1.2. items re-ordering by desired or defaut attribute in list view
As a UI user 
...
##### 7.5.1.3. items list default row height
As a UI user 
...
##### 7.5.1.4. Drag and drop columns in table to reorder columns order
...
##### 7.5.1.5. Columns resizing in table listing
As the UI user of an issue-tracker instance 
...
#### 7.6.1. Single Cell Items editing in list as table view
As an UI user of the issue-tracker application 
...
##### 7.6.1.1. Single Cell Items editing in list as table view in-line
As an UI user of the issue-tracker application 
In order to be able to quickly edit the data of ANY item I
...
##### 7.6.1.2. Items editing in list as table view via form
As an UI user of the issue-tracker application 
...
##### 7.6.1.3. Refresh list on item edit
As an UI user of the issue-tracker application 
...
#### 7.8.2. Items deletion from the edit form
As an UI user of the application 
I order to delete existing items in the project
...
#### 7.9.2. Issues export to Google calendar
As the UI user of an issue-tracker instance 
...
### 7.11. hierarchical items management
As an the ui user
...
### 7.14. UI for accessing different projects
As an issue-tracker ui user 
In order to be able to quickly switch between projects of the issue-tracker application instance I have access to
...
### 7.15. UI for Time management in Google Calendar
As an issue-tracker ui user 
...
### 7.16. items data transfer between different projects
As the UI user of an issue-tracker instance 
...
#### 7.16.1. Copy an issue-tracker instance issue to  a google calendar event
As an issue-tracker ui user 
...
### 7.17. Issues import from Google calendar
As the UI user of an issue-tracker instance 
In order to be able to visualize and manage my  start- and stop_time having issues better 
...
### 7.18. Access issues txt format from email
...
### 7.19. Access issues data from Google sheet
...
#### 7.19.1. Apply publish filter while posting to Google Sheet
As the biz user  of the issue tracker tool 
