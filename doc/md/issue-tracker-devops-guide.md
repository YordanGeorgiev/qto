...
Table of Contents
  ...
  * [7. SOURCE CODE MANAGEMENT](#7-source-code-management)
    * [7.1. The meaning of the used brances](#71-the-meaning-of-the-used-brances)
      * [7.1.1. Feature development in a feature branch](#711-feature-development-in-a-feature-branch)
    * [7.2. Branch for development - dev](#72-branch-for-development--dev)
    * [7.3. Testing and integrations in the tst branch](#73-testing-and-integrations-in-the-tst-branch)
    * [7.4. Quality assurance in the qas branch](#74-quality-assurance-in-the-qas-branch)
    * [7.5. Production in the prd branch](#75-production-in-the-prd-branch)
...
### 7.1. The meaning of the used brances
...
### 7.3. Testing and integrations in the tst branch
...
### 7.4. Quality assurance in the qas branch
...
### 7.5. Production in the prd branch
