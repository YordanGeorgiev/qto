...
1 3 * * * cd /home/ubuntu/opt/qto/qto.0.8.1.tst.ysg && bash ./src/bash/qto/qto.sh -a backup-postgres-PRD

# every day at 03:15 perform a full restart of the application layer in TST
15 3 * * * cd /home/ubuntu/opt/qto/qto.0.8.1.tst.ysg && bash ./src/bash/qto/qto.sh -a mojo-hypnotoad-start

# every day at 03:15 perform a full restart of the application layer in PRD
15 3 * * * cd /home/ubuntu/opt/qto/qto.0.8.1.prd.ysg && bash ./src/bash/qto/qto.sh -a mojo-hypnotoad-start

# every day at 19:00 perform a full db backup in TST
1 19 * * * cd /home/ubuntu/opt/qto/qto.0.8.1.tst.ysg && bash ./src/bash/qto/qto.sh -a backup-postgres-db
